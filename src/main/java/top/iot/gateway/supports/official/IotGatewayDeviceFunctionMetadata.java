 ...
 * @since 1.0.0
 */
public class IotGatewayDeviceFunctionMetadata implements FunctionMetadata {
    ...
    public IotGatewayDeviceFunctionMetadata() {
    }

    public IotGatewayDeviceFunctionMetadata(String id, String name, List<PropertyMetadata> inputs, DataType output) {
    ...
    public IotGatewayDeviceFunctionMetadata(JSONObject jsonObject) {
        fromJson(jsonObject);
    }

    public IotGatewayDeviceFunctionMetadata(FunctionMetadata another) {
        ...
        if (output == null && jsonObject != null) {
            output = Optional
                    ...
                    .flatMap(conf -> Optional
                            ...
                            .map(Supplier::get)
                            .map(type -> IotGatewayDataTypeCodecs.decode(type, conf)))
    ...
    public JSONObject toJson() {
        ...
        IotGatewayDataTypeCodecs.encode(getOutput())
    ...
    public FunctionMetadata merge(FunctionMetadata another, MergeOption... option) {
        IotGatewayDeviceFunctionMetadata function = new IotGatewayDeviceFunctionMetadata(this);
