...
public class DefaultThingsMetadata implements ThingMetadata {
    ...
    public DefaultThingsMetadata(ThingMetadata another) {
        ...
        this.properties = another.getProperties()
                                 ...
                                 .collect(Collectors.toMap(IotGatewayPropertyMetadata::getId, Function.identity(), (a, b) -> a, LinkedHashMap::new));

        this.functions = another.getFunctions()
                                .stream()
                                .map(IotGatewayDeviceFunctionMetadata::new)
                                .collect(Collectors.toMap(IotGatewayDeviceFunctionMetadata::getId, Function.identity(), (a, b) -> a, LinkedHashMap::new));

        this.events = another.getEvents()
                             .stream()
                             .map(IotGatewayEventMetadata::new)
                             .collect(Collectors.toMap(IotGatewayEventMetadata::getId, Function.identity(), (a, b) -> a, LinkedHashMap::new));
    ...
    public void addProperty(PropertyMetadata metadata) {
        ...
        this.properties.put(metadata.getId(), new IotGatewayPropertyMetadata(metadata));
        this.propertyMetadataList = Collections.unmodifiableList(new ArrayList<>(this.properties.values()));
    }
    ...
    public void addFunction(FunctionMetadata metadata) {
        ...
        this.functions.put(metadata.getId(), new IotGatewayDeviceFunctionMetadata(metadata));
    }
    ...
    public void addEvent(EventMetadata metadata) {
        ...
        this.events.put(metadata.getId(), new IotGatewayEventMetadata(metadata));
    }
    ...
    public void addTag(PropertyMetadata metadata) {
        ...
        this.tags.put(metadata.getId(), new IotGatewayPropertyMetadata(metadata));
    }
