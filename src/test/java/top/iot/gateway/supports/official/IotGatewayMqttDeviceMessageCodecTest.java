...
import top.iot.gateway.core.message.function.*;
...
public class IotGatewayMqttDeviceMessageCodecTest {

    IotGatewayMqttDeviceMessageCodec codec = new IotGatewayMqttDeviceMessageCodec();
